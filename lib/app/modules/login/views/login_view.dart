        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(child: Container(height: 1, color: const Color(0xFFC1C6D7))),
                  const Padding(
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: const Text('Google', style: TextStyle(color: Color(0xFF0B1C30), fontSize: 16)),
                    ),
                  ),
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: const Text('Apple', style: TextStyle(color: Color(0xFF0B1C30), fontSize: 16)),
                    ),
                  ),
                ],
              ),
